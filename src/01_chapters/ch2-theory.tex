...
%\paragraph{Data Sampling} %todo: deal with this section pls
...
%TODO: comment christina: not possible to measure without errors (heisenberg). But rather possible to determine reliability, precision, trueness of a signal aptly.
...
% todo: kommentar einfügen: Oder ganz generell: Um erkennen zu können ob das gemessene Signal richtig sein können muss das Sastem wissen was es misst. Diese Information muss in maschinenlesbarer Form vorliegen
...
\begin{description}
    ...
    %+TODO?: include more detailed examples. lol fuck
...
%TODO:perhaps small intro of SI
...
%todo: rough paragraph. fuck it all up
...
%TODO: migrate to "meet the istar" chapter
...
%TODO: chapter 2 summary. talking points:intro, definitions, algorithms, metadata, results
